    ...
    <div style={{ backgroundColor: "#0e0700", minHeight: "100vh", color: "#fef3c7" }}>
      <div style={{ backgroundColor: "#1a0e00", borderBottom: "1px solid #4a2800", padding: "36px 16px" }}>
        <div className="max-w-3xl mx-auto">
          <Link href="/nichijo" className="text-xs mb-3 inline-block" style={{ color: "#7c4a1a" }}>
            ← 日常トップ
          </Link>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-10">
        ...
        <div className="text-center pt-4">
          <Link href="/nichijo" className="text-sm" style={{ color: "#7c4a1a" }}>← 日常トップに戻る</Link>
        </div>
      </div>
    </div>
  );
